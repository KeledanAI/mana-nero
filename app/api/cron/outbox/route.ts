...
import { processOutboxBatch } from "@/lib/comms/process-outbox";

/**
 * Worker outbox: cron con `Authorization: Bearer …` usando OUTBOX_CRON_SECRET e/o CRON_SECRET (Vercel Cron).
 */
